              ...
              <nav className="navbar navbar-expand-lg navbar-light d-flex justify-content-lg-end">
                ...
                <div className="collapse navbar-collapse" id="navbarCollapse">
                  <div className="navbar-nav mx-0 mx-lg-auto">
                    ...
                    <NavLink to="/Aabout" className="nav-item nav-link">
                      AAbout
                    </NavLink>
                    <NavLink to="/Acourse" className="nav-item nav-link">
                      ACourses
                    </NavLink>
                    ...
                    <div className="nav-item dropdown">
                      ...
                      <div className="dropdown-menu">
                        ...
                        <NavLink hreto="*" className="dropdown-item">
                          
                        </NavLink>
                      </div>
                    </div>
                    <NavLink to="/Acontact" className="nav-item nav-link">
                      AContact
                    </NavLink>
                     <NavLink to="/addform" className="nav-item nav-link">
                      add form
                    </NavLink>
                    <NavLink to="/addformabout" className="nav-item nav-link">
                      add form about
                    </NavLink>
