...
function Test() {
  return (
    <div>
      ...
      <Display title={"Our Testimonial"} subtitle={"Testimonial"} />
      <div>
        {/* Testimonial Start */}
        <div
        ...
        >
          <div className="container py-5">
            ...
            >
              <div
                className="testimonial-item mx-auto"
                style={{ maxWidth: 900 }}
              >
                ...
                <p className="fs-4 text-white mb-4">
                  ...
                  quasi deleniti ratione similique eaque blanditiis fugit
                  voluptas ex officiis expedita repellat doloribus veniam
                  delectus tempore, laudantium, aliquam ad? Rem, accusantium?
                </p>
